...
<h3 align="center">
  ...
  <p align="center"><img src="https://img.shields.io/badge/WLCM%20TO -ArYAN MEDIA DOWNLOADER-green?colorA=%23ff0000&colorB=%23017e40&style=flat-square">  

</h3>

[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Neuton&size=25&color=30FF40&background=000000&center=true&vCenter=true&width=360&height=60&lines=Hello+World%2C+I'm+ArYAN-AHMRD-RUDRO+Here+🤙;𝙸𝚃'𝚜+𝙽𝙾𝚃+𝙰+𝙹𝚄𝚂𝚃+𝙽𝙰𝙼𝙴+𝙱𝚁𝙾+🥱;𝙸𝚃'𝚜+𝙰+𝙱𝚁𝙰𝙽𝙳+🔥;Respect+Itz-Aryan+🥀;Thanks+My+All+Friend+🤙+🥰)](https://git.io/typing-svg)


<a href="https://www.npmjs.com/package/aryan-media-downloader"><img alt="npm version" src="https://img.shields.io/npm/v/aryan-media-downloader.svg?style=flat-square"></a>
<img alt="version" src="https://img.shields.io/github/package-json/v/GITHUB-REPLIT/aryan-media-downloader?label=github&style=flat-square">
<a href="https://www.npmjs.com/package/aryan-media-downloader"><img src="https://img.shields.io/npm/dm/aryan-media-downloader.svg?style=flat-square" alt="npm downloads"></a><br>
[![Socket Badge](https://socket.dev/api/badge/npm/package/aryan-media-downloader)](https://socket.dev/npm/package/aryan-media-downloader) 
[![js dilvr](https://data.jsdelivr.com/v1/package/npm/aryan-media-downloader/badge)](https://www.jsdelivr.com/package/npm/aryan-media-downloader)

## Instalation :
```bash
> npm i aryan-media-downloader
```

## Example (Facebook)
```js
const fb = require('aryan-media-downloader');

const facebookUrl = 'https://www.facebook.com/share/v/Bbc4kPH9t1XXSJrA/?mibextid=oFDknk';

async function mainFB() {
  try {
    const result = await fb.aryanfbdl(facebookUrl);
    console.log(result);
  } catch (error) {
...
```
{
"Author": "ArYAN AHMED RUDRO",
" Whatsapp": "+8801894253289",
...
## Example (TikTok)
```js
const tik = require('aryan-media-downloader');

const tiktokUrl = 'https://vt.tiktok.com/ZSFtDDGwa/';

async function main() {
  try {
    const result = await tik.aryantikdl(tiktokUrl);
    console.log(result);
  } catch (error) {
    console.error('Error:', error.message);
  }
...
## Example (Instagram)
```js
const insta = require('aryan-media-downloader');

const instaUrl = 'https://www.instagram.com/reel/C5xU8OoRwdd/?igsh=MTM1MzF0M2szMTEwdg==';

async function main() {
  try {
    const result = await insta.aryaninsta(instaUrl);
    console.log(result);
  } catch (error) {
    console.error('Error:', error.message);
  }
...
## You can install `aryan-media-downloader` using npm:

```bash
npm install aryan-media-downloader
```
...
We welcome contributions! If you find any issues or have suggestions for improvement, feel free to open an issue or submit a pull request. If you want to contact me, check my [GitHub profile](https://github.com/GITHUB-REPLIT).
# developer information 
#### 𝗡𝗮𝗺𝗲         : ArYAN AHMED RUDRO
#### 𝗥𝗲𝗹𝗶𝗴𝗶𝗼𝗻    : (Islam)
#### 𝗣𝗲𝗿𝗺𝗮𝗻𝗲𝗻𝘁 𝗔𝗱𝗱𝗿𝗲𝘀𝘀 : (Dhaka)
#### 𝗖𝘂𝗿𝗿𝗲𝗻𝘁 𝗔𝗱𝗱𝗿𝗲𝘀𝘀 : Dhaka Gazipur 
#### 𝗚𝗲𝗻𝗱𝗲𝗿     : (male)
#### 𝗔𝗴𝗲            :  (18)
#### 𝗥𝗲𝗹𝗮𝘁𝗶𝗼𝗻𝘀𝗵𝗶𝗽 : (single)
#### 𝗚𝗺𝗮𝗶𝗹        :  vexaryan@gmail.com
#### 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺  : t.me/ArYANAHMEDRUDRO
### [Facebook](https://www.facebook.com/profile.php?id=61572658681308) 

`Copyright © 2025 ArYAN AHMED RUDRO`
